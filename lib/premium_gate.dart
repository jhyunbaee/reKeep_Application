...
class PremiumGate {
  /// 프리미엄 필요 팝업.
  /// 화면 높이의 90%까지 차지하는 풀스크린형 다이얼로그로,
  /// Premium 페이지와 동일한 내용/디자인을 보여준다.
  ///
  /// 반환값:
  ///  - true  : 다이얼로그 안에서 프리미엄을 구독 완료함
  ///  - false : 사용자가 닫음(취소)
    ...
    return showDialog<bool>(
      ...
      builder: (context) => Dialog(
        ...
        child: ConstrainedBox(
          ...
          child: _PremiumGateContent(message: message),
        ),
      ),
    );
  }
...
class _PremiumGateContent extends StatefulWidget {
  final String? message;
  const _PremiumGateContent({this.message});

  @override
  State<_PremiumGateContent> createState() => _PremiumGateContentState();
}

class _PremiumGateContentState extends State<_PremiumGateContent> {
